...
import SelectOption from "../ChildPage/RegisterTab/SelectOption";
import type { HocPhanDTO } from "../../../apis/types/HocPhan";
import CourseCard from "./RegisterTab/CourseList";
import { useDangKyHocPhan } from "../../../hooks/useDangKyHocPhan";
import { useHuyDangKyHocPhan } from "../../../hooks/useHuyDangKyHocPhan"; // import hook hủy đăng ký
import type {
  RequestChuyenLopHocPhanDTO,
  RequestDangKyDTO,
} from "../../../apis/types/dangKy";
import type { User } from "../../../apis/types/user";
import { useGetLopHocPhanDaDangKy } from "../../../hooks/useGetLopHocPhanDaDangKy";
import HocPhanDaDangKyTable from "./RegisterTab/HocPhanDaDangKyTable";
import { useChuyenLopHocPhan } from "../../../hooks/useChuyenLopHocPhan";
